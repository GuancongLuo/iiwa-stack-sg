...
int main()
{
  ...
  nh.getParam("CartesianPoseState/rotation_x", rotation_x);
  nh.getParam("CartesianPoseState/rotation_y", rotation_y);
  nh.getParam("CartesianPoseState/rotation_z", rotation_z);
  nh.getParam("CartesianPoseState/command_cartisian_mode", command_cartisian_mode);
  ...
  // get crurent iiwa cartesian pose
  ...
  // Wait a bit, so that you can be sure the command are sended.
